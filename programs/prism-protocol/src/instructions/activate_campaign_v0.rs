use crate::{error::ErrorCode, state::CampaignV0, CAMPAIGN_V0_SEED_PREFIX};
...
pub struct ActivateCampaignV0<'info> {
    ...
    #[account(
        ...
        constraint = !campaign.is_active @ ErrorCode::CampaignAlreadyActive,
    )]
...
pub fn handle_activate_campaign_v0(
    ...
    require!(go_live_slot >= current_slot, ErrorCode::InvalidGoLiveSlot);
